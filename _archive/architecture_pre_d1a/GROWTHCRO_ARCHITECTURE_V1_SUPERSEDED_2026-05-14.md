...
>
> **SUPERSEDED** by [`.claude/docs/architecture/PRODUCT_BOUNDARIES_V26AH.md`](../../.claude/docs/architecture/PRODUCT_BOUNDARIES_V26AH.md) §3-bis D1.A (2026-05-14, Mathis stamp 2026-05-14T16:30Z) which **locks single shell** (`webapp/apps/shell/` only). The 6-microfrontends layout described below has been retired: microfrontend apps live under `_archive/webapp_microfrontends_2026-05-12/`, the multi-zone `microfrontends.json` is no longer the routing source of truth.
>
> Kept for historical reference / design rationale only. Archived 2026-05-16 by issue [#41](https://github.com/GrowthSociety-GS/growth-cro/issues/41).
>
> ---

# GrowthCRO Architecture V1 (V28 target) — SUPERSEDED

**Version**: 1.0 — 2026-05-11
**Scope**: Webapp V28 (Next.js 14 + Supabase EU + Vercel microfrontends).
**Status**: ARCHIVED 2026-05-16. Superseded by `PRODUCT_BOUNDARIES_V26AH §3-bis` D1.A.
