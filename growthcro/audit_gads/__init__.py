"""Google Ads audit module — thin wrapper around the `anthropic-skills:gads-auditor` skill.

Exposes a small public surface so callers (CLI, FastAPI route) can:

* parse a Google Ads Editor CSV export into the canonical input bundle,
...
from growthcro.audit_gads.orchestrator import (
    AuditBundle,
    AuditInputs,
    AuditOutputs,
    run_audit,
