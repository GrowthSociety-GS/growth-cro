...
12. **Point d'entrée prochaine session** (post-clear 2026-05-13) : Lire [`docs/state/CONTINUATION_PLAN_2026-05-14.md`](docs/state/CONTINUATION_PLAN_2026-05-14.md) + master PRD ACTIVE [`.claude/prds/webapp-data-fidelity-and-skills-stratosphere-2026-05.md`](../prds/webapp-data-fidelity-and-skills-stratosphere-2026-05.md) + deep research [`docs/state/SKILLS_DEEP_RESEARCH_2026-05-13.md`](docs/state/SKILLS_DEEP_RESEARCH_2026-05-13.md) — post 2026-05-13 session marathon (13+ commits, 10 sub-PRDs Wave P0/P1/P2 shipped + SP-11 screenshots Supabase + RSC fix + skills deep research). Webapp Vercel live mais user a constaté **écran de fumée** (recos minimalistes, "Pas de scores", broken captures). Vraie cause : migration data sur mauvais fichier source. **Wave A blocking** : re-migrate depuis `recos_enriched.json` (438 files, V13 riche) + `score_*.json` (6 piliers/page) + debug screenshots prod. Puis Wave B skills stratosphère (skill-based-architecture + Superpowers + GStack + native /review + Vercel Agent). ETA 10-14h cumulé. 🔴 URGENT pre-action : rotater service_role JWT Supabase (repo PUBLIC + JWT in git history).
