// GSG Handoff — SP-5 (webapp-v26-parity-and-beyond) → relocated under
// `/gsg/handoff` in Sprint 10 / Task 010 (D3.A from
// `.claude/docs/architecture/DECISIONS_2026-05-14.md`). The Brief Wizard +
// Controlled Preview live here ; `/gsg` is now the Design Grammar viewer.
// Admin gating happens at the API layer (`POST /api/runs` requires admin) —
// the middleware already auth-walls the route.
//
...
import { HandoffBriefSection } from "@/components/gsg/HandoffBriefSection";
...
export default async function GsgHandoffPage({
  ...
  return (
    <main className="gc-gsg-shell">
      ...
      {/* Sprint 10 / Task 010 — Brief Wizard (V2) wired to TriggerRunButton +
          live `<GsgRunPreview>` so a run can be launched + previewed without
          leaving the page. */}
      <HandoffBriefSection
  ...
  return (
    <div className="gc-topbar">
      ...
      <div className="gc-toolbar">
        <a href="/gsg" className="gc-pill gc-pill--soft">
          ← Design Grammar
        </a>
...
function ClientPicker({
  ...
  return (
    <form className="gc-client-picker" method="get" action="/gsg/handoff">
