...
//
// B1 (Issue #72, 2026-05-17) — Sidebar removed from this page : chrome is
// rendered uniformly via `app/layout.tsx`. The route stays accessible via URL
// (FR-25) but is hidden from the sidebar nav + Cmd+K palette.
